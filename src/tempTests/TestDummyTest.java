...
public class TestDummyTest {
	...
	public static void main(String[] args) throws MalformedURLException, UnsupportedEncodingException {
		...
		try {
			...
			/*if (testUtils.dummyTest("ApplicationNotResponding",3))
				System.out.println("Found an Exception");
			if (testUtils.dummyTest("Play Store"))
				System.out.println("Found an Exception");
			if (testUtils.dummyTest("Play Store",20))
				System.out.println("Found an Exception");
			
			if (testUtils.dummyTest("Play Store",20,TimeUnit.SECONDS))
				System.out.println("Found an Exception");
			
			if (testUtils.dummyTest("Play Store",5,20,TimeUnit.SECONDS))
				System.out.println("Found an Exception");
			
			testUtils.setRandomSeed(7);
			if (testUtils.dummyTest("Play Store",2))
				System.out.println("Found an Exception");
			if (testUtils.dummyTest("Play Store",2))
				System.out.println("Found an Exception");
			if (testUtils.dummyTest("Play Store",2))
